...
# nor should you worry about invalid characters; assume 
# all characters will be numeric.

# # You may not use any of the standard conversion 
# methods available in Ruby to convert a string to a 
# number, such as String#to_i, Integer(), etc. Your 
# method should do this the old-fashioned way and 
#   calculate the result by analyzing the characters 
#   in the string.
