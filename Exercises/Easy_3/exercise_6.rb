...
# both of its operands are truthy. If both operands are falsey, 
# it returns a falsey value. The && operator returns a truthy value 
# if both of its operands are truthy, and a falsey value 
# if either operand is falsey. This works great until you need 
