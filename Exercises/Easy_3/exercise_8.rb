...
# palindrome reads the same forward and backward. For 
# this exercise, case matters as does punctuation and spaces.
...
p palindrome?(['dog', 'bog']) == false   
p palindrome?(['dog', 'bog', 'dog']) == true  